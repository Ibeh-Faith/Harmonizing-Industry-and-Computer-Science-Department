...
class cusers_add extends cusers {
	...
	function LoadDefaultValues() {
		...
		$this->status->CurrentValue = "Not Verified";
	}
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($users->name->FldCaption()) ?>");
			...
			if (elm && !ew_HasValue(elm))
				return this.OnError(elm, ewLanguage.Phrase("EnterRequiredField") + " - <?php echo ew_JsEncode2($users->status->FldCaption()) ?>");
...
<?php if ($users->name->Visible) { // name ?>
	<tr id="r_name">
		<td><span id="elh_users_name"><?php echo $users->name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $users->name->CellAttributes() ?>>
<span id="el_users_name" class="control-group">
<input type="text" data-field="x_name" name="x_name" id="x_name" size="30" maxlength="200" placeholder="<?php echo $users->name->PlaceHolder ?>" value="<?php echo $users->name->EditValue ?>"<?php echo $users->name->EditAttributes() ?>>
</span>
...
<textarea data-field="x__email" name="x__email" id="x__email" cols="35" rows="4" placeholder="<?php echo $users->_email->PlaceHolder ?>"<?php echo $users->_email->EditAttributes() ?>><?php echo $users->_email->EditValue ?></textarea>
</span>
...
<input type="text" data-field="x_password" name="x_password" id="x_password" size="30" maxlength="100" placeholder="<?php echo $users->password->PlaceHolder ?>" value="<?php echo $users->password->EditValue ?>"<?php echo $users->password->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_phone" name="x_phone" id="x_phone" size="30" maxlength="100" placeholder="<?php echo $users->phone->PlaceHolder ?>" value="<?php echo $users->phone->EditValue ?>"<?php echo $users->phone->EditAttributes() ?>>
</span>
...
<input type="text" data-field="x_type" name="x_type" id="x_type" size="30" maxlength="1" placeholder="<?php echo $users->type->PlaceHolder ?>" value="<?php echo $users->type->EditValue ?>"<?php echo $users->type->EditAttributes() ?>>
</span>
...
<?php if ($users->status->Visible) { // status ?>
	<tr id="r_status">
		<td><span id="elh_users_status"><?php echo $users->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></span></td>
		<td<?php echo $users->status->CellAttributes() ?>>
<span id="el_users_status" class="control-group">
...
if (is_array($arwrk)) {
	...
	for ($rowcntwrk = 0; $rowcntwrk < $rowswrk; $rowcntwrk++) {
		$selwrk = (strval($users->status->CurrentValue) == strval($arwrk[$rowcntwrk][0])) ? " checked=\"checked\"" : "";
...
<?php echo $users->status->CustomMsg ?></td>
	</tr>
<?php } ?>
</table>
</td></tr></table>
