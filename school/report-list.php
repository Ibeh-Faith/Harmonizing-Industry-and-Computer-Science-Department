...
$sql = mysqli_query($con, "SELECT * FROM report 
                            JOIN users on report.from = users.id
                            WHERE report.to = '$id'
                            ORDER BY `date` ")or die(mysqli_error($con));
                                ...
                                <table class="table table-bordered table-striped table-hover with-check">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                    <a style="cursor: pointer" href="reports.php?mid=<?php echo $data->id?>"><?php echo $data->name?></a></td>
                                            
                                            <td><?php echo $data->email?></td>
                                            <!--  -->
                                            <td><?php echo date("D M j, H:i", strtotime($data->date)) ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>                            
